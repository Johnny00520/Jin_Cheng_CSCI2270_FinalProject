...
Since you can only run with Terminal Emulator, you will have to use commend-line argument with the name ""Assignment6Movies.txt"", it's not working,
Please do the "set program argument" with the file "Assignment6Movies.txt".
